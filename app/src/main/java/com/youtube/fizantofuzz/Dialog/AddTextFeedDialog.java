...
public class AddTextFeedDialog extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.dialog_add_text_feed, container, false);
    }
        ...
        add_feed_upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!title.getText().toString().equals("") && !date.getText().toString().equals("") && !body.getText().toString().equals("") && imageUri != null){
                    reference = FirebaseDatabase.getInstance().getReference("Feed").child(time);
                    ...
                    if(!title.getText().toString().equals("") && !date.getText().toString().equals("") && !body.getText().toString().equals("") && imageUri != null){
                        reference = FirebaseDatabase.getInstance().getReference("Feed").child(parent);
